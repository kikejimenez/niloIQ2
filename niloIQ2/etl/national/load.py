# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/01_etl/00_NationalPrices/01_LoadData.ipynb.

# %% auto 0
__all__ = ['USER', 'PASS', 'HOST', 'PORT', 'DB', 'sqlEngine', 'dbConnection', 'new_version']

# %% ../../../nbs/01_etl/00_NationalPrices/01_LoadData.ipynb 2
...
# %% ../../../nbs/01_etl/00_NationalPrices/01_LoadData.ipynb 4
load_dotenv()
